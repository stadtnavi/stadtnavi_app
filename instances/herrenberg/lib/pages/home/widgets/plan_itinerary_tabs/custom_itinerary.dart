...
import 'package:de_stadtnavi_herrenberg_internal/widget/alerts/fetch_error_handler.dart';
...
class CustomItinerary extends StatefulWidget {
  final IRoutingMapComponent iRoutingMapComponent;

  const CustomItinerary({super.key, required this.iRoutingMapComponent});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (buildContext, index) {
                      ...
                      return ItineraryCard(
                        ...
                        selectItinerary:
                            (selectedItinerary, {showAllItineraries}) {
        ...
        if (showDetail && mapRouteState.selectedItinerary != null)
          Card(
            ...
            child: ItineraryDetailsCard(
              ...
              moveInMap: (latLng, {zoom}) =>
                  widget.iRoutingMapComponent.controller.setCameraPosition(
                    TrufiCameraPosition(target: latLng, zoom: zoom ?? 15),
                  ),
            ),
          ),
      ],
