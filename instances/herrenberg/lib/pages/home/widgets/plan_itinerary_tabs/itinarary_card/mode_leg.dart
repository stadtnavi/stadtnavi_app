...
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinarary_card/icon_transport.dart';
...
class RouteLeg extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final perc = legLength.abs() / 10;
    final isRedenderBike =
        beforeLeg?.transportMode == TransportMode.bicycle &&
    ...
    return SizedBox(
      ...
      child: IconTransport(
        ...
        icon: leg.transportMode.getImage(
          color: leg.transportMode == TransportMode.carPool
              ? Colors.transparent
              : Colors.white,
        ),
