...
import 'package:de_stadtnavi_herrenberg_internal/pages/home/offer_carpool/offer_carpool_screen.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinerary_details_card/custom_text_button.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinerary_details_card/itinerary_details_card.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinerary_details_card/step_navigation_details.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinerary_details_card/transit_leg.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/widgets/plan_itinerary_tabs/itinerary_details_card/widgets/info_message.dart';
import 'package:flutter/material.dart';
import 'package:latlong2/latlong.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:trufi_core/extensions/stadtnavi_models/enums_plan/enums_plan.dart';
import 'package:trufi_core/extensions/stadtnavi_models/enums_plan/icons/icons_transport_modes.dart';
...
import 'package:trufi_core/extensions/utils/alert_utils.dart';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CustomTextButton(
                        ...
                        onPressed: () async {
                          final mapRouteState = context
                              .read<MapRouteCubit>()
                              .state;
                          // final mapModesCubit = context.read<MapModesCubit>();
                          // final settingFetchState = context
                          //     .read<SettingFetchCubit>()
                          //     .state;
          ...
          DashLinePlace(
            ...
            alertSeverityIcon: AlertActionIcon.getActiveAlertSeverityLevel(
              ...
              ontap: () {
                // panelCubit.setPanel(
                //   CustomMarkerPanel(
                //     panel: (context, _, {isOnlyDestination}) =>
                //         StopMarkerModalBase(
                //           initialIndex: 2,
...
class AlertActionIcon extends StatelessWidget {
  ...
  final AlertSeverityLevelTypeTrufi alertSeverityLevelType;
