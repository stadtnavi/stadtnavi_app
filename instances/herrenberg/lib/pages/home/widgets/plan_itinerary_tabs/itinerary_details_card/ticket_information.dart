...
import 'package:trufi_core/extensions/utils/fare_utils.dart';
...
class _TicketInformationState extends State<TicketInformation> {
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  // TODO review fare.agency not defined
                  // ...fares!.map((fare) {
  ...
  Future<void> loadFares() async {
    if (widget.itinerary.compressLegs.isNotEmpty &&
      ...
      fetchFares(widget.itinerary, faresUrl!)
          .then((value) {
            if (mounted) {
              setState(() {
                ...
                unknownFares = getUnknownFares(
                  value,
                  fares,
                  getRoutes(widget.itinerary.compressLegs),
                );
                loading = false;
              });
            }
