...
import 'package:de_stadtnavi_herrenberg_internal/pages/home/setting_payload/setting_panel/sharing_operator_selector.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ...ConfigDefault.value.formFactorsAndDefaultMessages.keys
            .map((formFactor) {
              final formFactorsAndDefault = ConfigDefault
                  .value
                  .formFactorsAndDefaultMessages[formFactor]!;
              ...
              return operators.isNotEmpty
                  ? [
                      CustomSwitchTile(
                        title: localizationST.translate(
                          formFactorsAndDefault.translationKey,
                        ),
                        secondary: SizedBox(
                          height: 35,
                          width: 35,
