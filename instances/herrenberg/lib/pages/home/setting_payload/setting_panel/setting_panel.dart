...
import 'package:de_stadtnavi_herrenberg_internal/pages/home/setting_payload/setting_panel/sharing_settings_panel.dart';
import 'package:de_stadtnavi_herrenberg_internal/pages/home/setting_payload/setting_panel/speed_expanded_tile.dart';
...
class SettingPanel extends StatefulWidget {
  ...
  static const Divider dividerSection = Divider(thickness: 1, height: 0);
  ...
  static const Divider dividerWeight = Divider(thickness: 10);
...
class _SettingPanelState extends State<SettingPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizationST.commonSettings),
        leading: BackButton(
          onPressed: () {
            Navigator.of(context).pop(payloadDataPlanCubit.state);
          },
            ...
            return Scrollbar(
              child: ListView(
                children: <Widget>[
                  ...
                  SpeedExpansionTile(
                    title: localizationST.settingPanelWalkingSpeed,
                    dataSpeeds: WalkingSpeed.values
                        .map(
                          (e) => DataSpeed(
                            e.translateValue(localizationST),
                            e.speed,
                          ),
                        )
                        .toList(),
                    textSelected: state.walkSpeed.translateValue(localizationST),
                    onChanged: (value) {
                      final WalkingSpeed selected = WalkingSpeed.values
                          .firstWhere(
                            (element) =>
                                element.translateValue(localizationST) == value,
                          );
                  ...
                  CustomSwitchTile(
                    title: localizationST.settingPanelAvoidWalking,
                    isSubSection: true,
                  ...
                  Container(
                    ...
                    child: Text(
                      localizationST.settingPanelTransportModes,
                  ...
                  CustomSwitchTile(
                    ...
                    onChanged: (_) {
                      payloadDataPlanCubit.setTransportMode(
                  ...
                  if (TransportMode.funicular.visible)
                    CustomSwitchTile(
                      title: localizationST.instructionVehicleRackRailway,
                      ...
                      value: state.transportModes.contains(
                  ...
                  SettingPanel.dividerSection,
                  CustomSwitchTile(
                    title: localizationST.settingPanelAvoidTransfers,
                    isSubSection: true,
                  ...
                  Container(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                      localizationST.settingPanelMyModesTransport,
                      style: theme.textTheme.bodyLarge,
                    ),
                  ),
                  CustomSwitchTile(
                    title: localizationST.settingPanelMyModesTransportBike,
                    secondary: SizedBox(
                      height: 35,
                      width: 35,
                      child: bicycleSvg(),
                  ...
                  Container(
                    ...
                    child: Text(
                      localizationST.bicycleParkingFilter,
                      style: theme.textTheme.bodyLarge,
                    ),
                  ),
                  SpeedExpansionTile(
                    ...
                    dataSpeeds: BicycleParkingFilter.values
                        ...
                        .toList(),
                    textSelected: state.bicycleParkingFilter.translateValue(
                      localization,
                    ),
                    onChanged: (value) {
                      final BicycleParkingFilter selected = BicycleParkingFilter
                          .values
                          .firstWhere(
                            (element) =>
                  ...
                  SpeedExpansionTile(
                    title: localizationST.settingPanelBikingSpeed,
                    isSubSection: true,
                    dataSpeeds: BikingSpeed.values
                        .map((e) => DataSpeed(e.translateValue(), ''))
                        .toList(),
                  ...
                  Container(
                    ...
                    child: CustomSwitchTile(
                      title: localizationST.settingPanelMyModesTransportBikeRide,
                      secondary: null,
                      isSubSection: true,
                  ...
                  SettingPanel.dividerSection,
                  CustomSwitchTile(
                    title: localizationST.settingPanelMyModesTransportParkRide,
                    secondary: SizedBox(
                      height: 35,
                      width: 35,
                      child: parkRideSvg,
                  ...
                  CustomSwitchTile(
                    ...
                    secondary: SizedBox(height: 35, width: 35, child: carSvg()),
                  ...
                  Container(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                      localizationST.settingPanelAccessibility,
                      style: theme.textTheme.bodyLarge,
                    ),
                  ),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16.0),
                    child: Text(localizationST.settingPanelAccessibilityDetails),
                  ),
                  const SizedBox(height: 10),
                ],
              ),
