...
class BuildTransitErrorAlert extends StatelessWidget {
  ...
  const BuildTransitErrorAlert({Key? key, required this.exception})
    : super(key: key);
  ...
  Future<void> _reportRouteError(String languageCode) async {
    const routeFeedbackUrl = "https://trufifeedback.z15.web.core.windows.net/route.html";
    String version = await PackageInfoPlatform.version();
    final LatLng? currentLocation = GPSLocationProvider().current;
    launch(
